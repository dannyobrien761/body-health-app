...
![responsivity Mockup](/assets/media/media-for--readme/amiresponsive.png)
...
![lighthouse scrore screenshot](/assets/media/media-for--readme/lighthouse-summary.png)
## Deployment
...
![content placeholder js file inspiration](/assets/media/media-for--readme/image-3.png)

### Excerpt from my initial solution to show the appropriate herb cards on click:

![commit history 'js code for 2 body parts and 1 card'](/assets/media/media-for--readme/image.png)
